    ...
    return (
        <div className="py-4">
            ...
            <div className="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-2 max-w-[400px]">
                <Input autoFocus type="text" className="text-base px-3 py-2 w-full sm:min-w-[350px] min-w-[315px]" placeholder="Search by category (e.g. Watches)" onChange={handleChange} />
